...
matplotlib.use('Agg')  # 修改为无界面后端，避免GUI问题
...
print(f"Torchvision 版本: {models.__version__ if hasattr(models, '__version__') else '未知'}")
...
def check_environment():
    ...
    # 检查Tkinter支持（仅提示，已改用Agg后端）
    try:
        import tkinter
        print("Tkinter 支持: 正常")
    except ImportError:
        print("Tkinter 支持: 缺失（不影响程序运行）")
